...
public class CheckJDFWrapper
{
	...
	private static Logger log = Logger.getLogger(CheckJDFWrapper.class);
	...
	public static boolean validate(InputStream jdfIn, File reportFile) throws IOException
	{
		...
		try
		{
			...
			return validate(tempJdf, new File("../testdata/schema/JDF.xsd"), null, reportFile);
	 ...
	 *            the JDF instance or JMF message to parse
	 * @param report
	 *            a buffer to append the XML validation report to
	 * @return true if valid; false otherwise
	 */
	...
	{
		return validate(jdfFile, new File("../testdata/schema/JDF.xsd"), null, reportFile);
	}
	 ...
	 *            The file to write the validation XML report to. If
	 *            <code>null</code> no XML report is written.
	 * @return <code>true</code> if JDF file passed validatio;
	...
	/**
	 * Calls JDFLib-J's <i>CheckJDF</i> using the specified command-line
	 * arguments. Before calling CheckJDF two temporary files are created: one
	 * to which the input JDF data will be written; and one to which CheckJDF's
	 * XML test report will be written. See
	 * {@link #validateCommandLine(String, File, File)} for details.
	 * 
	 * @param commandLine
	 *            the command line
	 * @param jdfData
	 *            a <code>String</code> containing the JDF instance to
	 *            validate
	 * @param report
	 *            a <code>StringBuffer</code> to which CheckJDF's XML test
	 *            report will be appended
	 * @return <code>true</code> if the JDF was valid; <code>false</code>
	 *         otherwise
	 * @throws IOException
	 *             if the temporary files could not be written/read
	 */
	...
	/**
	 * Calls JDFLib-J's <i>CheckJDF</i> with the specified command-line
	 * arguments. Before calling CheckJDF two temporary files are created: one
	 * to which the input JDF data will be written; and one to which CheckJDF's
	 * XML test report will be written. See
	 * {@link #validateCommandLine(String, File, File)} for details.
	 * 
	 * @param commandLine
	 *            the command-line arguments for CheckJDF
	 * @param jdfStream
	 *            an <code>InputStream</code> from the JDF instance to
	 *            validate
	 * @param report
	 *            a <code>StringBuffer</code> to which CheckJDF's XML report
	 *            is appended
	 * @return <code>true</code> if the JDF instance was valid;
	 *         <code>false</code> otherwise
	 * @throws IOException
	...
	/**
	 * Calls JDFLib-J's <i>CheckJDF</i> with the specified command-line
	 * arguments. Before calling CheckJDF a temporary file is created to which
	 * the input JDF data will be written. See
	 * {@link #validateCommandLine(String, File, File)} for details.
	 * 
	 * @param commandLine
	 *            the command-line arguments for CheckJDF
	 ...
	 *            validate
	 * @param reportFile
	 *            the file to which CheckJDF's XML report will be written
	 * @return <code>true</code> if the JDF instance was valid;
	 *         <code>false</code> otherwise
	 * @throws IOException
	 */
	...
	/**
	 * Calls JDFLib-J's <i>CheckJDF</i> with the specified command-line
	 * arguments. The following subsitution variables can be used to insert the
	 * paths of the JDF file and the report file in the command-line arguments:
	 * <ul>
	 * <li><code>$J</code> - will be replaced by the absolute path to the JDF
	 * file</li>
	 * <li><code>$R</code> - will be replaced by the absolute path to the XML
	 * report file</li>
	 * </ul>
	 * 
	 * @param commandLine
