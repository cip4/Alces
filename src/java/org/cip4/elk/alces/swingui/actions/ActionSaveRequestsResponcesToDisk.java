...
import org.cip4.elk.alces.swingui.tree.message.AbstractMessageNode;
...
public class ActionSaveRequestsResponcesToDisk extends AbstractAction {
    private static Log log = LogFactory.getLog(ActionSaveRequestsResponcesToDisk.class);
...
//      create folder
        ...
        /*if (success) {
            ...
            System.out.println("Directory: " + strDirectory + " does not created");
        }*/
