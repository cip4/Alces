...
/**
 * Requires that Elk is running on http://elk.itn.liu.se/elk/jmf
 * 
...
public class TestSessionXMLBindingTest extends AlcesTestCase {
    ...
    public void testSerialize() throws Exception {        
        ...
        TestSuiteSerializer ser = new TestSuiteSerializer("src/conf/report");
    ...
    public void testToXML() throws Exception {
        ...
        // Load and send a message
        OutMessage mOut = new OutMessageImpl("", getResourceAsString("KnownDevices.xml"), true);
        session.sendMessage(mOut);
        // Load and fake message that matches the sent messsage
        InMessage mIn = new InMessageImpl("", getResourceAsString("KnownDevicesReply.xml"), true);
