...
/**
 * Base class for all Alces test cases. Provides convenience methods for accessing resources, etc.
 *
 * @author Claes Buckwalter (clabu@itn.liu.se)
 */
public abstract class AlcesTestCase {
     ...
     *
     * @param filePath a test file relative <code>src/test/data/<TestClassName>/</code>
     * @return
     * @throws IOException
     */
