...
public class ConfigurableXPathsTest extends Test {
    ...
    private static Log log = LogFactory.getLog(ConfigurableXPathsTest.class);
    ...
    /* (non-Javadoc)
     * @see org.cip4.elk.alces.test.tests.Test#runTest(org.cip4.elk.alces.message.Message)
     */
    @Override
        ...
        try {
            ...
            for (Iterator i = _xpaths.keySet().iterator(); i.hasNext(); ) {
                ...
                if (n.getPrefix().length() == 0) {
                    ...
                    log.debug("Assigned namespace prefix '" + _defaultNsPrefix
                ...
                for (Iterator j = nodes.iterator(); j.hasNext();) {
                    ...
                    if (o instanceof String) {
                        passedTest = passedTest && o.equals("true");
                    } else {
                        passedTest = false;
                    }
                }
            ...
            logMsg = "An error occurred while validating the message body. Maybe the"
