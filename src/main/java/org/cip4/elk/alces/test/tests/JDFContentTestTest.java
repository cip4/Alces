 ...
 */
public class JDFContentTestTest extends AlcesTestCase {

    public void testInvalidJMF() {
        Message msg = new InMessageImpl("text/xml", null, "<?xml version='1.0' encoding='UTF-8'?><JMF TimeStamp='2005-05-05T10:49:30+02:00' Version='1.1' xmlns='http://www.CIP4.org/JDFSchema_1_1' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'><Signal ID='Link82970634_000011' Type='QueueStatus' refID='ALCESac0b51bd20dbf85a'><Notification AgentName='CIP4 JDF Writer Java' AgentVersion='1.2.42 alpha' Class='Event' TimeStamp='2005-05-05T10:49:30+02:00'><Comment>Status Change: Waiting -&gt; Closed</Comment><Comment>QueueStatusEvent[Status: Closed;  Class: JDFAutoNotification.EnumClass[Event=1];  Source: org.cip4.elk.impl.queue.MemoryQueue@e4d5ba;  Time stamp: 1115282970510]</Comment></Notification><Queue DeviceID='Elk' QueueSize='0' Status='Closed'/></Signal></JMF>", true);
        assertFalse(JDFConstants.JMF_CONTENT_TYPE.equals(msg.getContentType()));
    ...
    public void testValidJMF() {
        ...
        assertEquals(JDFConstants.JMF_CONTENT_TYPE, msg.getContentType());
        Test test = new JDFContentTest();
        TestResult result = test.runTest(msg);
