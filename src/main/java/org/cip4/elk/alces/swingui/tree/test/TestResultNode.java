...
public class TestResultNode extends DefaultMutableTreeNode implements
     ...
     * (non-Javadoc)
     * 
     * @see org.cip4.elk.alces.test.TestResult#getLogMessage()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cip4.elk.alces.test.TestResult#getMessage()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cip4.elk.alces.test.TestResult#isPassed()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.cip4.elk.alces.test.TestResult#getTest()
     */
    public Test getTest() {
