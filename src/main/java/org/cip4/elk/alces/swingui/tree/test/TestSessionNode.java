package org.cip4.elk.alces.swingui.tree.test;
...
import org.cip4.elk.alces.swingui.tree.message.InMessageNode;
import org.cip4.elk.alces.swingui.tree.message.OutMessageNode;
import org.cip4.elk.alces.test.TestResult;
import org.cip4.elk.alces.test.TestSession;
import org.cip4.elk.alces.test.TestSessionListener;
 ...
 * <code>TestSession</code>. This class wraps a non-Swing TestSession
 * implementation. The wrapped TestSession contains the logic, this class is simply
 * a wrapper allowing the TestSession to be displayed in a Swing JTree. 
 * 
 * @author Claes Buckwalter
 */
public class TestSessionNode extends DefaultMutableTreeNode implements
		TestSession {

	private static final long serialVersionUID = 865715767294195142L;

	protected static Log log = LogFactory.getLog(TestSessionNode.class);
...
//	}
    ...
    public TestSessionNode(TestSession testSession, DefaultTreeModel treeModel, boolean asyncMode) {
		if (testSession instanceof TreeNode) {
			throw new IllegalArgumentException(
					"The TestSession may not be a TreeNode.");
		}
	...
	/**
	 * Wraps the <code>OutMessage</code> in a <code>OutMessageNode</code> if
	 * necessary, then adds the message as a direct child to this tree node if
	 * it is an initiating message.
	 * 
	 * @see org.cip4.elk.alces.TestSession#sendMessage(org.cip4.elk.alces.OutMessage)
	 */
	...
	/**
	 * Wraps the <code>InMessage</code> in a <code>InMessageNode</code> if
	 * necessary, then adds the InMessage as a direct child to this tree node if
	 * it is an initiating message.
	 * @param message  the incoming message to receive
	 * @see org.cip4.elk.alces.TestSession#receiveMessage(org.cip4.elk.alces.InMessage)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.cip4.elk.alces.TestSession#addOutgoingTest(org.cip4.elk.alces.tests.Test)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.cip4.elk.alces.TestSession#addIncomingTest(org.cip4.elk.alces.tests.Test)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.cip4.elk.alces.TestSession#addTestResult(org.cip4.elk.alces.TestResult)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.cip4.elk.alces.TestSession#getIncomingMessages()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.cip4.elk.alces.TestSession#getOutgoingMessages()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.cip4.elk.alces.TestSession#getTestResults()
	 */
