 ...
 */
package org.cip4.elk.alces.swingui.tree.message;
...
import org.cip4.elk.alces.swingui.tree.test.TestResultNode;
...
/**
 * A <code>DefaultMutableTreeNode</code> implementation of a <code>Message</code>.
 * This class wraps a non-Swing implementation of a Message. The wrapped Message 
 * contains the logic, this class is simply a wrapper so that the Message can be
 * displayed in a Swing JTree.
 * 
 * @see javax.swing.tree.DefaultMutableTreeNode
 * @see org.cip4.elk.alces.message.Message
 * @author Claes Buckwalter
 * @version $Id$
 */
public abstract class AbstractMessageNode extends DefaultMutableTreeNode implements
        Message {

    protected static Log log = LogFactory.getLog(AbstractMessageNode.class);
    
    protected Message _wrappedMessage = null;
    protected DefaultTreeModel _treeModel = null;
   
    /**
     * Creates a new Message that is a TreeNode and wraps a non-Swing 
     * Message implementation. The wrapped Message contains the logic, this class
     * is simply a wrapper so that the Message can be displayed in a JTree.
    ...
    /* (non-Javadoc)
     * @see org.cip4.elk.alces.Message#getBody()
     */
    ...
    /* (non-Javadoc)
     * @see org.cip4.elk.alces.Message#setBody(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see org.cip4.elk.alces.Message#getBodyAsJDOM()
     */
    ...
    /* (non-Javadoc)
     * @see org.cip4.elk.alces.Message#getBodyAsJMF()
     */
    ...
    /* (non-Javadoc)
     * @see org.cip4.elk.alces.Message#getBodyAsJDF()
     */
    ...
    /* (non-Javadoc)
     * @see org.cip4.elk.alces.Message#getHeader()
     */
    ...
    /* (non-Javadoc)
     * @see org.cip4.elk.alces.Message#setHeader(java.lang.String)
     */
    ...
    /**
     * Wraps a TestResult in a TestResultNode and adds it to the Message and to the
     * TestSuite's TreeModel.
     */
    ...
    /* (non-Javadoc)
     * @see org.cip4.elk.alces.Message#getTestResults()
     */
