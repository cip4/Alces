...
public class TestRunnerServiceImpl implements TestRunnerService {
    ...
    public synchronized OutgoingJmfMessage getOutgoingMessage(TestSession testSession, IncomingJmfMessage message) {
    ...
    public void receiveMessage(TestSession testSession, IncomingJmfMessage incomingJmfMessage, OutgoingJmfMessage outgoingJmfMessage) {
...
//		}
     ...
     */
    public synchronized void receiveMessage(TestSession testSession, IncomingJmfMessage incomingJmfMessage) {
     ...
     * @return
     */
    public TestSession startTestSession(OutgoingJmfMessage outgoingJmfMessage, File jdfFile, PreprocessorContext context, String targetUrl, boolean asMime) {
