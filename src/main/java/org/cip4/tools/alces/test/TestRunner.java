...
public class TestRunner {
	 ...
	 * session are tested by the {@link org.cip4.tools.alces.test.tests.Test}s
	 * configured for this <code>TestRunner</code>.
	 * 
	 * All outgoing messages are preprocessed by the
	 * {@link org.cip4.tools.alces.preprocessor.jmf.Preprocessor}s configured for
	...
	public void init() throws Exception {
		...
		try {
			...
			final String resourceBase = TestRunner.class.getResource(_confHand.getProp(ConfigurationHandler.RESOURCE_BASE)).getFile();
	...
	public File publishJDF(File jdfFile) {
		...
		String publicDirPath = TestRunner.class.getResource(_confHand.getProp(ConfigurationHandler.RESOURCE_BASE)).getFile();
		// Create JDF dir
