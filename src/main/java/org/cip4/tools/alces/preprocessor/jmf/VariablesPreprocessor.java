...
/**
 * A preprocessor that replaces variables in the JMF. See {@linkplain http
 * ://commons
 * .apache.org/lang/api-2.3/org/apache/commons/lang/text/StrSubstitutor.html}
 * for details on the the variables name-value map and the syntax in the JMF
 * template.
 * 
 * <p>
 ...
 * @deprecated Use org.cip4.elk.alces.preprocessor.VariablesPreprocessor instead
 */
@Deprecated
public class VariablesPreprocessor implements Preprocessor {
	...
	public static final String VARIABLES_MAP = "org.cip4.elk.alces.jmf.VariablesPreprocessor.VARIABLES_MAP";
