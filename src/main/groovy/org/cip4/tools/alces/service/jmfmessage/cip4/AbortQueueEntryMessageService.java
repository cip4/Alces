...
@Service
public class AbortQueueEntryMessageService implements JmfMessageService {


    @Override
    public boolean accepts(MessageService messageService) {
        return Objects.equals(messageService.getType(), "AbortQueueEntry");
    }
    ...
    public String createJmfMessage(IntegrationUtils integrationUtils, StateInfo stateInfo) {
        return integrationUtils.getJmfBuilder()
                .buildAbortQueueEntry(stateInfo.getSelectedQueueEntryId())
                .toXML();
    }
}
