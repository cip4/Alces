...
@Service
public class HoldQueueEntryMessageService implements JmfMessageService {

    @Override
    public boolean accepts(MessageService messageService) {
        return Objects.equals(messageService.getType(), "HoldQueueEntry");
    }
    ...
    public String createJmfMessage(IntegrationUtils integrationUtils, StateInfo stateInfo) {
        return integrationUtils.getJmfBuilder()
                .buildHoldQueueEntry(stateInfo.getSelectedQueueEntryId())
                .toXML();
    }
}
