...
@Service
public class RemoveQueueEntryMessageService implements JmfMessageService {

    @Override
    public boolean accepts(MessageService messageService) {
        return Objects.equals(messageService.getType(), "RemoveQueueEntry");
    }
    ...
    public String createJmfMessage(IntegrationUtils integrationUtils, StateInfo stateInfo) {
        return integrationUtils.getJmfBuilder()
                .buildRemoveQueueEntry(stateInfo.getSelectedQueueEntryId())
                .toXML();
    }
}
