...
public class JMFPreprocessor implements Preprocessor {
	...
	public JMFPreprocessor(String senderId) throws PreprocessorException {
		...
		try {
			...
			throw new PreprocessorException("Could not configure XPaths for preprocessing.", je);
		}
	}
	...
	private void buildXPaths() throws JDOMException {
		Namespace jdfNamespace = Namespace.getNamespace(JDF_NS_PREFIX, JDF_NS_URI);
	...
	public AbstractJmfMessage preprocess(final AbstractJmfMessage message) throws PreprocessorException {
		...
		try {
			...
			String msg = "The message could not be preprocessed. The message body " + "could not be parsed. Maybe it did not contain XML?";
	...
	/**
	 * This is an ID generator for JDF that generates "pure IDs " (se below). Generates a 20 characters long string of hexadecimal values on the form:
	 * 
	 * <code>ALCESxxxxxxxxxxxxxxxx</code>
	 * 
	 * The middle 8 characters are the 32 lower bits of System.currentTimeMillis().
	 * 
	 * The last 8 characters are 4 random bytes generated by java.security.SecureRandom.
	 * 
	 ...
	 * </pre>
	 * 
	 * References: GUIDs without Singletons and Databases http://www.theserverside.com/patterns/thread.jsp?thread_id=4976
	 * 
	 * Entity Bean Primary Key Generator http://www.theserverside.com/patterns/thread.jsp?thread_id=220
	 * 
	...
	private static class IDGenerator20 {
		 ...
		 * </pre>
		 * 
		 * @param bytes The array containing the bytes to be converted
		 * @param length The number of bytes in the array to be converted, starting from index the beginning of the array
		...
		/**
		 * Generates a unique ID string of hexadecimal values on the form: ALCESxxxxxxxxxxxxxxxx
		 * 
		 * The middle 8 characters are the 32 lower bits of System.currentTimeMillis().
		 * 
		 * The last 8 characters are a 4 random bytes generated by java.security.SecureRandom.
		 * 
		 * @return String
		 */
